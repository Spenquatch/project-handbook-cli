...
""",
    "task": (
        ...
        "task-docs-deep-dive|sprint-gate] [--release current|vX.Y.Z] [--gate]\n"
        "                        - Scaffold a new sprint task directory with docs/checklists\n"
        "\n"
        "  Notes:\n"
        "    --type is canonical. Session template is derived from --type.\n"
...
""",
    "release": (
        ...
        "                                - Quick snapshot for current (or specified) release\n"
        "  ph release show [--release current|vX.Y.Z]\n"
        "                                - Print releases/<release>/plan.md + full report "
        "(also refreshes progress.md)\n"
