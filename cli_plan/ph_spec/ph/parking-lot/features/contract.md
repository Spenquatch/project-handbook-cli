---
title: PH Spec Contract — ph/parking-lot/features/
type: contract
tags: [ph, spec]
---
...
- Created/updated by:
  ...
  - `ph parking add --type features ...` (creates a new item directory + `README.md` and updates `ph/parking-lot/index.json`).
- Non-destructive:
