...
## Creation
- Created/updated by:
  - `ph parking add --type research --title "..." ...` (creates a new item directory + `README.md` and updates `parking-lot/index.json`).
...
## Examples Mapping
- `examples/RES-20251230-process-fix-session-end-index-/README.md` demonstrates a research parking-lot item `README.md` with required front matter keys.
