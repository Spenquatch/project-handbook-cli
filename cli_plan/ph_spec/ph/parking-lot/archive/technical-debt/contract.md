---
title: PH Spec Contract — parking-lot/archive/technical-debt/
type: contract
tags: [ph, spec]
---
...
## Directory Purpose
- Path (handbook instance): `PH_ROOT/parking-lot/archive/technical-debt/`
...
## Creation
- Created/updated by:
  - Technical-debt parking-lot items are archived by moving an existing `parking-lot/technical-debt/<DEBT-...>/` directory into `parking-lot/archive/technical-debt/<DEBT-...>/` (manual).
- Non-destructive:
