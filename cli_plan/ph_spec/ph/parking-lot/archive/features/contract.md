---
title: PH Spec Contract — parking-lot/archive/features/
type: contract
tags: [ph, spec]
---
...
## Directory Purpose
- Path (handbook instance): `PH_ROOT/parking-lot/archive/features/`
...
## Creation
- Created/updated by:
  - Feature parking-lot items are archived by moving an existing `parking-lot/features/<FEAT-...>/` directory into `parking-lot/archive/features/<FEAT-...>/` (manual).
- Non-destructive:
