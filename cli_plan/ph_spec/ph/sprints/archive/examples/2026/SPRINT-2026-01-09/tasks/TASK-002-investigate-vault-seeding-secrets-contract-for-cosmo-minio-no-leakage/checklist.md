...
- [x] `project-handbook/decision-register/DR-0004-vault-secrets-contract-cosmo-minio.md`:
...
- [x] `project-handbook/features/v2_registry-cosmo-minio-required/implementation/IMPLEMENTATION.md` updated with:
...
- [x] Evidence exists under `project-handbook/status/evidence/TASK-002/` and is referenced from DR-0004
