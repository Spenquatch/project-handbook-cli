...
- [x] `ph/decision-register/DR-0005-router-supergraph-consumption-from-cosmo.md`:
...
- [x] `ph/features/v2_schema-publishing-and-composition/implementation/IMPLEMENTATION.md` updated with:
  - [x] execution-ready Router consumption plan (auth material + refresh model)
  - [x] exact v2 config file paths to change
- [x] Evidence exists under `ph/status/evidence/TASK-003/` and is referenced from DR-0005
