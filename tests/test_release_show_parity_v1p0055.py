...
def _write_release_show_fixture(ph_root: Path) -> str:
    ...
    (release_dir / "plan.md").write_text(plan_text, encoding="utf-8")
...
def test_release_show_stdout_parity_v1p0055(tmp_path: Path) -> None:
    _write_minimal_ph_root(tmp_path)
    plan_text = _write_release_show_fixture(tmp_path)
    ...
    expected_status_lines = [
        ...
        "Overall Progress: 100% complete (2/2 features started)",
        ...
        "Tagged Workstream: 100% (6/6 pts) across 3 tasks (2 features)",
        "Tagged Trajectory: 🟢 GREEN - Ahead of expected completion for Sprint 1",
        "  Expected completion band: 0–50% by end of Sprint 1/2",
        "Gate Burn-up: 1/1 complete (in timeline: 1/1)",
        "Release Readiness: 🟢 GREEN - Ready to ship",
        "",
        "🎯 Feature Progress:",
